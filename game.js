...
document.addEventListener('DOMContentLoaded', function(){
    ...
    [['A#', 6], ['Bb', 6], ['D#', 5], ['Eb', 5], ['G#', 4], ['Ab', 4], ['C#', 3], ['Db', 3], ['F', 2], ['A#', 1], ['Bb', 1]], //fret 6
    [['B', 6], ['E', 5], ['A', 4], ['D', 3], ['F#', 2], ['Gb', 2], ['B', 1]], //fret 7
    [['C', 6], ['F', 5], ['A#', 4], ['Bb', 4], ['D#', 3], ['Eb', 3], ['G', 2], ['C', 1]],  //fret 8
    [['C#', 6], ['Db', 6], ['F#', 5], ['Gb', 5], ['B', 4], ['E', 3], ['Ab', 2], ['G#', 2], ['C#', 1], ['Db', 1]], //fret 9
    [['D', 6], ['G', 5], ['C', 4], ['F', 3], ['A', 2], ['D', 1]], //fret 10
    [['D#', 6], ['Eb', 6], ['G#', 5], ['Ab', 5], ['C#', 4], ['Db', 4], ['F#', 3], ['Gb', 3], ['A#', 2], ['Bb', 2], ['D#', 1], ['Eb', 1]], //fret 11
    [['E', 6], ['A', 5], ['D', 4], ['G', 3], ['B', 2], ['E', 1]]  //fret 12
]; 
